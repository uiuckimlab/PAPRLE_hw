...
def generate_launch_description():
    ...
    robot_description = Command([
        ...
        PathJoinSubstitution([
            FindPackageShare('papras_table'),
            'description/urdf',
            'dual_7dof_metal_arm_hw.xacro',
        ]),
        ' ',
        'usb_port:=', usb_port,
        ' ',
    ...
    included_launches = []
    # # RVIZ
    launch_dir = os.path.join(get_package_share_directory('two_7dof_metal_papras_visionpro_moveit_config'), 'launch')
    if start_rviz:

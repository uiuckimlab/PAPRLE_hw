...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('robot_pos_z', default_value='0.0'),
    ...
    robot_description = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare('papras_orthrus'),
                    'description/urdf',
                    'spot_7dof_teleop_gazebo.urdf.xacro'
                ]
            ),
        ]
    )
    ...
    moveit_package_name = 'papras_orthrus_moveit_config'
    ...
    print("p------------------------", pkg_dir)
    os.environ['GAZEBO_MODEL_PATH'] += f':{pkg_dir}/../'
    pose = {

...
class SpotROS():
    ...
    def initNavCallback(self, msg):
        """ROS subscriber for the init_nav service"""
        self.spot_wrapper.init_nav(msg.data)
    ...
    def main(self):
        ...
        rospy.loginfo(f"ROS driver for Spot is {'' if self.spot_wrapper.is_valid else 'not '}valid")
        ...
        if self.spot_wrapper.is_valid:
            ...
            rospy.Subscriber("init_nav", String, self.initNavCallback, queue_size=1)
